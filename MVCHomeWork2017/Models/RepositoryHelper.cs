namespace MVCHomeWork2017.Models
{
	public static class RepositoryHelper
	{
		...
		public static CustomerViewRepository GetCustomerViewRepository()
		{
			var repository = new CustomerViewRepository();
			repository.UnitOfWork = GetUnitOfWork();
			return repository;
		}

		public static CustomerViewRepository GetCustomerViewRepository(IUnitOfWork unitOfWork)
		{
			var repository = new CustomerViewRepository();
